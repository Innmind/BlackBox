...
class SetTest extends TestCase
{
    public function testInterface()
    {
        $this->assertInstanceOf(
            Set::class,
            new Set\Set('string', new Set\Chars)
        );
    }
    ...
    public function testOf()
    {
        $this->assertInstanceOf(
            Set\Set::class,
            Set\Set::of('string', new Set\Chars)
        );
    }

    public function testGenerates100ValuesByDefault()
    {
        $sets = new Set\Set('string', new Set\Chars);
    ...
    {
        $sets1 = new Set\Set('string', new Set\Chars);
        $sets2 = $sets1->take(50);

        $this->assertNotSame($sets1, $sets2);
        $this->assertInstanceOf(Set\Set::class, $sets2);
