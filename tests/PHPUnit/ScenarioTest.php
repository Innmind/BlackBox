...
class ScenarioTest extends TestCase
{
    ...
    {
        $scenario = new Scenario(fn() => false, Integers::any());
    ...
    {
        $scenario = new Scenario(fn() => false, Integers::any(), Integers::any());
    ...
    {
        $scenario1 = new Scenario(fn() => false, Integers::any(), Integers::any());
